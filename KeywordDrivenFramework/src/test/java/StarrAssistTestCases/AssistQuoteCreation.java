...
public class AssistQuoteCreation extends BaseTest
{
	...
	*/		 wdriver.get("https://saqa.solartis.net/");
			 ...
			 stmt.executeUpdate("update ParallelTest1 set status='pass' where S_No="+RowIterator);
		   ...
		   @DataProvider(name="datafromdb",parallel=true)
			 public Object[][] getDataFromdb() throws DatabaseException, PropertiesHandleException
			 {
			   LinkedHashMap<Integer, LinkedHashMap<String, String>> inputtable=null;
				 inputtable = this.GetDataObjects("com.mysql.jdbc.Driver","jdbc:mysql://192.168.84.225:3700/TestDB_Starr","root","redhat","SELECT * FROM ParallelTest1");

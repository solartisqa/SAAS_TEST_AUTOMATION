...
public interface MacroInterface {
	...
	public void PumpinData(LinkedHashMap<String, String> inputData, PropertiesHandle configFile)
			throws DatabaseException, POIException, MacroException;

	public void PumpoutData(LinkedHashMap<String, String> outputData, LinkedHashMap<String, String> inputData,
			PropertiesHandle configFile) throws POIException, MacroException, DatabaseException;
